...
// Order.belongsTo(User, { foreignKey: "userId", as: "user" }); // Alias "user" for includes
...
// // 🏠 Address - User
// Address.belongsTo(User, { foreignKey: "userId" }); // Assuming Address belongs to a user as well
// User.hasMany(Address, { foreignKey: "userId" }); // User can have many addresses
