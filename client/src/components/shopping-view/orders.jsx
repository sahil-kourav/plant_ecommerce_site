  ...
  return (
    <Card className="w-full bg-white shadow-lg rounded-2xl">
      ...
      <CardContent className="p-0">
        ...
        {/* Mobile & Tablet View */}
        <div className="sm:hidden px-3 py-4 space-y-5">
          {orderList?.length > 0 &&
            orderList.map((orderItem) => (
              <div
                key={orderItem.id}
                className="border rounded-2xl p-4 shadow-sm bg-white space-y-3"
              >
                <div className="text-[15px] text-gray-800 font-medium">
                  <span className="block text-gray-600 font-semibold">Order ID:</span>
                  <span className="break-words">{orderItem.id}</span>
                </div>
                ...
                <div className="text-[15px] text-gray-800 font-medium">
                  ...
                  <Badge
                    className={`mt-1 inline-block capitalize py-1 px-3 text-white text-xs font-semibold rounded-full ${
                      orderItem.orderStatus === "confirmed"
                        ? "bg-green-500"
                        : orderItem.orderStatus === "rejected"
                        ? "bg-red-600"
                ...
                <div className="text-[15px] text-gray-800 font-medium">
                  <span className="block text-gray-600 font-semibold">Total:</span>
                ...
                >
                  <Button
                    className="w-full mt-3 text-sm bg-primary hover:bg-primary/90 rounded-xl py-2"
                    onClick={() => handleFetchOrderDetails(orderItem.id)}
                  >
                    View Details
                  </Button>
